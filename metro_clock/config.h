...
#define LIGHT_SENS_ADC 170 //значение ацп, при котором можно считать что достаточно темно(0..255)

#define SLEEP_TIME 5 //время ухода в сон(3..60)(с)
#define BAT_TIME 30 //время опроса заряда акб(5..120(с)

const uint8_t timerDefault [] = { 1, 2, 5, 10, 15, 30, 60 }; //пресеты таймера(1..99)(м)(не более 7 пресетов)
